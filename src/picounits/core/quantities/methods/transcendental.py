...
def _valid_input_for_logarithms(
    q: QuantityPacket, n: float | int, method: str
) -> None:
    """ If q.magnitude <= 0 or n <= 0 or n == 1, raises value error """
    if not isinstance(n, (float, int)):
        mag = type(q.magnitude)     # Inline length too long
...
def csc_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def sec_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def cot_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def asin_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def acos_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def atan_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def atan2_logic(
    q_y: QuantityPacket, q_x: QuantityPacket, factory: ImplementedQ
) -> QuantityPacket:
    """
    ...
    return factory(new_magnitude, DIMENSIONLESS)


def acsc_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def asec_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def acot_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
    ...
    """
    if q.magnitude == 0:
        mag = q.magnitude   # Inline length too
...
def sinh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def cosh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def tanh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def csch_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def sech_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def coth_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
...
def asinh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def acosh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def atanh_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def acsch_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
    ...
    """
    if q.magnitude == 0:
        mag = q.magnitude   # Inline length too long
...
def asech_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def acoth_logic(q: QuantityPacket, factory: ImplementedQ) -> QuantityPacket:
    """
...
def log_logic(
    q: QuantityPacket, n: float | int, factory: ImplementedQ
) -> QuantityPacket:
